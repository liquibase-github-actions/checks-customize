...
ERRORONCIRCULARINCLUDEALL=${22}
FILEENCODING=${23}
FILTERLOGMESSAGES=${24}
FLOWVERBOSETOSTRING=${25}
GENERATECHANGESETCREATEDVALUES=${26}
GENERATEDCHANGESETIDSCONTAINSDESCRIPTION=${27}
HEADLESS=${28}
INCLUDECATALOGINSPECIFICATION=${29}
INCLUDESYSTEMCLASSPATH=${30}
LICENSEKEY=${31}
LIQUIBASECATALOGNAME=${32}
LIQUIBASESCHEMANAME=${33}
LIQUIBASETABLESPACENAME=${34}
LOGCHANNELS=${35}
LOGFILE=${36}
LOGFORMAT=${37}
LOGLEVEL=${38}
MIRRORCONSOLEMESSAGESTOLOG=${39}
MISSINGPROPERTYMODE=${40}
MONITORPERFORMANCE=${41}
NATIVEEXECUTOR=${42}
ONMISSINGINCLUDECHANGELOG=${43}
OUTPUTFILE=${44}
...
SHOWBANNER=${58}
SQLLOGLEVEL=${59}
SQLSHOWSQLWARNINGS=${60}
STRICT=${61}
SUPPORTPROPERTYESCAPING=${62}
USEPROCEDURESCHEMA=${63}
VALIDATEXMLCHANGELOGFILES=${64}
