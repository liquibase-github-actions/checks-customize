# Liquibase Checks Customize Action
...
```yaml
- uses: liquibase-github-actions/checks-customize@v4.33.0
  with:
...
- uses: liquibase/setup-liquibase@v1
  with:
    ...
    edition: 'oss'
- run: liquibase checks-customize # add your parameters as CLI flags
```
